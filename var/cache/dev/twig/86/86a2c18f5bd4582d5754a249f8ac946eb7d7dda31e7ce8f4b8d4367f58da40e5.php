...
class __TwigTemplate_f070bd99f126fe1750dd5349faba09708799a78ae1940a43490855f55f46a0df extends Template
{
    private $source;
    private $macros = [];
    ...
    ";
        ...
        if (twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 11, $this->source); })()), "user", [], "any", false, false, false, 11)) {
            // line 12
            echo "        <div class=\"mb-3\">
            Bạn đã đăng nhập bằng tài khoản ";
            // line 13
...
<form method=\"post\">
    ...
    {% if app.user %}
        <div class=\"mb-3\">
            Bạn đã đăng nhập bằng tài khoản {{ app.user.username }}, <a href=\"{{ path('app_logout') }}\">Đăng xuất</a>
        </div>
    {% else %}
...
{% endblock %}
", "security/login.html.twig", "E:\\xampp\\htdocs\\wincofood\\templates\\security\\login.html.twig");
    }
}
