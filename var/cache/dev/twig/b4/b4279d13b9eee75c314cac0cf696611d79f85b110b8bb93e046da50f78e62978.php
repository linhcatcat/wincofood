...
class __TwigTemplate_0376ad30f89f27f8ecacb73715897cc75f76f268101b484df35d508d49de77f0 extends Template
{
    private $source;
    private $macros = [];
...
{% block body %}
    ...
    <p>
        The requested page couldn't be located. Checkout for any URL
        misspelling or <a href=\"{{ path('article_list') }}\">return to the homepage</a>.
    </p>
{% endblock %}", "@Twig/Exception/error404.html.twig", "E:\\xampp\\htdocs\\wincofood\\templates\\bundles\\TwigBundle\\Exception\\error404.html.twig");
    }
}
