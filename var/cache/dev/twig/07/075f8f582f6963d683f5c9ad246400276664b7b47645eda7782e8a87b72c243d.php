...
class __TwigTemplate_0a4f2cdf3604818fbc55542ca032d6cb4c3423a6105b98cac3b2bc2b668da499 extends Template
{
    private $source;
    private $macros = [];
 ...
 <p>";
        // line 7
        echo twig_get_attribute($this->env, $this->source, (isset($context["article"]) || array_key_exists("article", $context) ? $context["article"] : (function () { throw new RuntimeError('Variable "article" does not exist.', 7, $this->source); })()), "body", [], "any", false, false, false, 7);
        echo "</p>
 <hr>
 <a href=\"/\">Go Back</a>
";
...
{% block body %}
 ...
 <hr>
 <a href=\"/\">Go Back</a>
{% endblock %}", "articles/show.html.twig", "E:\\xampp\\htdocs\\wincofood\\templates\\articles\\show.html.twig");
    }
}
